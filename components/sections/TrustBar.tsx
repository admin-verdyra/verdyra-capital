...
export default function TrustBar() {
  return (
    <section className="border-t border-[#0F5A3A]/10 bg-[#F8FAF9] px-6 py-16 sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-7xl grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 auto-rows-fr items-stretch">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="group h-full rounded-[24px] border border-slate-200 bg-white p-6 shadow-[0_16px_45px_rgba(17,17,17,0.05)] transition duration-300 hover:-translate-y-1 hover:border-[#B8860B]/40 hover:shadow-[0_20px_55px_rgba(184,134,11,0.14)]"
          >
