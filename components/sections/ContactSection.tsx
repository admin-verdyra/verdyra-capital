...
function ContactIcon({
  ...
  return (
    <span className="flex items-center justify-center">{icons[type]}</span>
  );
}
...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="bg-[#F8FAF9] px-6 py-12 sm:px-8 lg:px-10 lg:py-16"
    >
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-base leading-7 text-slate-600">
              Our financing specialists are ready to help you identify the best
              funding options for your business or personal financial
              requirements.
            </p>
            ...
            <div className="mt-8 rounded-[20px] border border-slate-200 bg-[#F8FAF9] p-5 sm:p-6">
              <p className="text-base font-semibold text-[#111111]">
                Helping businesses and individuals access financing through
                India&apos;s leading Banks, NBFCs and regulated financial
                institutions.
              </p>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Need help choosing the right financing solution? Our specialists
          ...
          <div className="rounded-[24px] border border-slate-200 bg-[#F8FAF9] p-5 shadow-[0_12px_30px_rgba(17,17,17,0.04)] sm:p-6">
            ...
            <div className="space-y-3 text-sm text-slate-700">
              {contactDetails.map((item) => (
                <div
                  key={item.title}
                  className="flex items-start gap-3 rounded-2xl border border-slate-200/70 bg-white/80 p-3.5"
                >
                  ...
                  <div className="min-w-0">
                    ...
                    {item.href ? (
                      ...
                      <p className="mt-1 whitespace-pre-line text-[#0F5A3A]">
                        {item.value}
                      </p>
                    )}
                  </div>
