...
export default function Navbar() {
  ...
  <Link
    href="/portal"
    className="inline-flex h-12 items-center justify-center rounded-full border border-[#0F6B47] px-6 text-[15px] font-semibold text-[#0F6B47] transition hover:bg-[#F3F7F4]"
  >
    Customer Portal
  </Link>
          ...
          <div className="absolute right-4 top-20 w-[88%] max-w-[320px] rounded-xl bg-white p-4 shadow-xl">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link
                href="/portal"
                onClick={() => setOpen(false)}
                className="mt-2 inline-flex w-full items-center justify-center rounded-full border border-[#0F6B47] px-4 py-3 text-sm font-semibold text-[#0F6B47]"
              >
                Customer Portal
              </Link>
