...
export async function GET(request: Request) {
  ...
  if (!tokenHash || type !== "recovery") {
    console.log("[verify] validation failed: missing token_hash or type !== recovery");
...
<body>
  <div class="container">
    ...
    <a href="/portal">Return to Login</a>
  </div>
</body>
</html>`,
      {
  ...
  const destination = redirectTo ? decodeURIComponent(redirectTo) : "/portal/reset-password";
